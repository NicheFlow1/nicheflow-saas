...
const NAV = [
  ...
  { href: '/dashboard/audience',     label: 'Audience',       icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  { section: 'AI Tools' },
...
export default function Sidebar({ profile }: { profile?: null | { email?: string; full_name?: string } }) {
  ...
  return (
    <aside style={{
      ...
      display: 'flex', flexDirection: 'column', zIndex: 100, overflowY: 'hidden',
      ...
      {/* Dashboard - fixed, never scrolls away */}
      ...
      {/* Nav */}
      <nav style={{ flex: 1, padding: '4px 8px 10px', overflowY: 'auto', scrollbarWidth: 'none' } as React.CSSProperties}>
        {NAV.map((item, idx) => {
          if ('section' in item) {
            return (
