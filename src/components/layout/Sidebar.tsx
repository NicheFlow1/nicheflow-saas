...
import{LayoutDashboard,Search,Radio,TrendingUp,Settings,LogOut,Zap}from'lucide-react'
  ...
  return(
    <aside className='sidebar'>
      <div className='sidebar-logo'>
        ...
        <div><div className='logo-text'>NicheFlow</div><div className='logo-badge'>AI Scout</div></div>
      </div>
      ...
      <div className='sidebar-footer'>
        <div className='usage-widget'>
          <div className='usage-label'><span style={{fontSize:10,fontWeight:700,color:'var(--text-tertiary)',textTransform:'uppercase',letterSpacing:'.04em'}}>{PLAN_LIMITS[plan]?.label||'Free'}</span><span style={{fontSize:10,color:'var(--text-disabled)'}}>{used}/{limit}</span></div>
