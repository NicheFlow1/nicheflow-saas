...
const STATS = [
  { label: 'Niches Analyzed',  value: '2,847', delta: '+12 today',  color: '#7c3aed' },
  { label: 'Picks Saved',      value: '143',   delta: '+3 this week', color: '#10b981' },
  { label: 'Avg Opp Score',    value: '81.4',  delta: '↑ 2.1 pts',   color: '#f59e0b' },
  { label: 'Markets Tracked',  value: '38',    delta: '6 new niches', color: '#3b82f6' },
];
...
export default function DashboardPage() {
  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1100px' }}>
      ...
      {/* CTA banner */}
      <div style={{ background: 'linear-gradient(135deg, #7c3aed22, #4f46e522)', border: '1px solid var(--accent)', borderRadius: '16px', padding: '24px 28px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
        ...
        <Link href="/dashboard/daily-picks" style={{ background: 'var(--accent)', color: '#fff', padding: '10px 22px', borderRadius: '10px', fontWeight: 700, fontSize: '14px', textDecoration: 'none', flexShrink: 0 }}>
          View Picks →
        </Link>
      </div>
    </div>
